...
class Ui_ExportForm(object):
    def setupUi(self, ExportForm):
        ...
        self.login_status.setGeometry(QtCore.QRect(500, 50, 181, 31))
        font = QtGui.QFont()
        ...
        self.export_bt.setGeometry(QtCore.QRect(30, 410, 171, 41))
        font = QtGui.QFont()
        ...
        self.export_status.setGeometry(QtCore.QRect(40, 370, 221, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.logout.setGeometry(QtCore.QRect(304, 13, 71, 31))
        ...
        self.refresh_qr = QtWidgets.QPushButton(ExportForm)
        self.refresh_qr.setGeometry(QtCore.QRect(470, 360, 51, 24))
        self.refresh_qr.setObjectName("refresh_qr")
        self.frame_unlogin = QtWidgets.QFrame(ExportForm)
        self.frame_unlogin.setGeometry(QtCore.QRect(20, 10, 161, 41))
        self.frame_unlogin.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_unlogin.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_unlogin.setObjectName("frame_unlogin")
        self.register_bt = QtWidgets.QPushButton(self.frame_unlogin)
        self.register_bt.setGeometry(QtCore.QRect(10, 10, 61, 24))
        self.register_bt.setObjectName("register_bt")
        self.login_bt = QtWidgets.QPushButton(self.frame_unlogin)
        self.login_bt.setGeometry(QtCore.QRect(90, 10, 61, 24))
        self.login_bt.setObjectName("login_bt")
        self.label_username = QtWidgets.QLabel(ExportForm)
        self.label_username.setGeometry(QtCore.QRect(30, 10, 201, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
    ...
    def retranslateUi(self, ExportForm):
        ...
        self.export_bt.setText(_translate("ExportForm", "导出"))
        ...
        self.refresh_qr.setText(_translate("ExportForm", "刷新"))
